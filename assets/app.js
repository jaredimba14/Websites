...
function homeHero() {
  return `
    <section class="home-hero hero-gradient -mt-[200px] overflow-hidden bg-navy-deep pt-[200px] text-white">
      ${particles()}
      <img class="home-hero-portrait home-hero-portrait-warm" src="./assets/hero-portrait-warm.png" alt="" aria-hidden="true" />
          ...
          ${items.map((item) => `
            <article class="contact-option-card luxe-card flex flex-col p-6">
              ...
              <div class="contact-option-actions mt-auto pt-6">
                <a href="${item.href}" ${item.intent ? `data-contact-intent="${item.intent}"` : ""} ${item.booking ? `target="_blank" rel="noopener" data-integration-placeholder="booking"` : ""} class="btn btn-navy justify-center">${icon(item.icon)} ${item.label}</a>
              </div>
            </article>
          `).join("")}
        </div>
      ...
      <div class="relative z-10 mx-auto grid max-w-7xl items-center gap-10 px-4 pb-16 pt-20 sm:px-6 lg:grid-cols-[1fr_.86fr] lg:px-8 lg:pt-24">
        <div class="reveal">
          ...
          <div class="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <a href="${PLACEHOLDER_BOOKING_URL}" target="_blank" rel="noopener" data-integration-placeholder="booking" class="btn btn-ghost justify-center">${icon("calendar")} Book Your Appointment</a>
          </div>
...
function membershipsPage() {
  ...
  return `
    ...
    <section class="section-shell bg-ivory"><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="mx-auto max-w-4xl text-center"><p class="eyebrow">Google Reviews</p><h2 class="mt-3 font-serif text-4xl font-semibold text-navy sm:text-5xl">Trusted For Provider Led Care and A Premium Client Experience</h2><p class="mt-4 leading-8 text-ink/68">Clients trust Elite VitaMed for personalized aesthetic and wellness care performed by a Nurse Practitioner and certified injector, with the privacy and convenience of concierge appointments.</p><div class="mt-6 text-2xl tracking-[.18em] text-champagne">★★★★★</div><p class="mt-2 text-sm font-bold text-navy">Rated [X.X] stars on Google</p></div><div class="mt-9 grid gap-5 md:grid-cols-2">${["[Insert Google review here.]", "[Insert Google review here.]"].map((item) => `<article class="luxe-card p-6"><p class="text-lg tracking-[.12em] text-champagne">★★★★★</p><p class="mt-4 font-serif text-2xl leading-8 text-navy">"${item}"</p><p class="mt-5 text-xs font-bold uppercase tracking-[.14em] text-ink/55">Client Name · Google Review</p></article>`).join("")}</div><div class="mt-8 flex justify-center"><a href="${PLACEHOLDER_REVIEWS_URL}" target="_blank" rel="noopener" data-integration-placeholder="reviews" class="btn btn-navy justify-center">${icon("users")} Read More Reviews</a></div></div></section>
...
function resultsPage() {
  ...
  return `
    ...
    <section class="section-shell bg-ivory"><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="mx-auto max-w-4xl text-center"><p class="eyebrow">Client Reviews</p><h2 class="mt-3 font-serif text-4xl font-semibold text-navy sm:text-5xl">Trusted For Provider Led Care and A Premium Client Experience</h2><p class="mt-4 leading-8 text-ink/68">Clients trust Elite VitaMed for personalized aesthetic and wellness care performed by a Nurse Practitioner and certified injector, with the privacy and convenience of concierge appointments.</p><div class="mt-6 text-2xl tracking-[.18em] text-champagne">★★★★★</div><p class="mt-2 text-sm font-bold text-navy">Rated [X.X] stars on Google</p></div><div class="mt-9 grid gap-5 lg:grid-cols-3">${["[Insert Google review here.]", "[Insert Google review here.]", "[Insert Google review here.]"].map((item) => `<article class="luxe-card p-6"><p class="text-lg tracking-[.12em] text-champagne">★★★★★</p><p class="mt-4 font-serif text-2xl leading-8 text-navy">"${item}"</p><p class="mt-5 text-xs font-bold uppercase tracking-[.14em] text-ink/55">Client Name · Google Review</p></article>`).join("")}</div><div class="mt-8 flex justify-center"><a href="${PLACEHOLDER_REVIEWS_URL}" target="_blank" rel="noopener" data-integration-placeholder="reviews" class="btn btn-navy justify-center">${icon("users")} Read More Reviews</a></div></div></section>
        ...
        <div class="neuro-map-shell mt-10 grid gap-7 lg:grid-cols-[.92fr_1.08fr]">
          <div class="neuro-face-card">
            <div class="neuro-face-stage">
              <img class="neuro-face" src="./assets/treatment-face-map.png" alt="Front-facing facial treatment map illustration for Botox and neurotoxin education" />
          ...
          <article class="neuro-info-card" data-neuro-info>
            ...
            <div class="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a href="#contact" class="btn btn-navy justify-center">${icon("calendar")} Book Your Appointment</a>
              <a href="#assessment" class="btn border border-navy/15 bg-white text-navy justify-center">${icon("sparkle")} Start Injectable Assessment</a>
            </div>
          </article>
        </div>
    ...
    <section class="section-shell bg-ivory">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="neuro-map-shell mt-10 grid gap-7 lg:grid-cols-[.92fr_1.08fr]">
          <div class="neuro-face-card">
            <div class="neuro-face-stage">
              <img class="neuro-face" src="./assets/treatment-face-map.png" alt="Front-facing facial treatment map illustration for dermal filler education" />
    ...
    <section class="section-shell bg-ivory">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="neuro-map-shell mt-10 grid gap-7 lg:grid-cols-[.92fr_1.08fr]">
          <div class="neuro-face-card">
            <div class="neuro-face-stage">
              <img class="neuro-face" src="./assets/treatment-face-map.png" alt="Front-facing facial planning map illustration" />
    ...
    <section class="section-shell bg-ivory">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="neuro-map-shell mt-10 grid gap-7 lg:grid-cols-[.92fr_1.08fr]">
          <div class="neuro-face-card">
            <div class="neuro-face-stage">
              <img class="neuro-face" src="./assets/treatment-face-map.png" alt="Front-facing educational non surgical face lift combination treatment map" />
    ...
    <section class="section-shell bg-ivory">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="neuro-map-shell mt-10 grid gap-7 lg:grid-cols-[.92fr_1.08fr]">
          <div class="neuro-face-card">
            <div class="neuro-face-stage">
              <img class="neuro-face" src="./assets/treatment-face-map.png" alt="Front-facing educational PDO thread planning map illustration" />
              ${pdoThreadVectors()}
...
function botoxPage() {
  ...
  return `
    ...
    <section class="bg-navy-deep px-4 py-16 text-white"><div class="mx-auto max-w-7xl rounded-[1.5rem] border border-champagne/25 bg-white/5 p-7 text-center sm:px-10"><p class="eyebrow">Not Sure What You Need?</p><h2 class="mx-auto mt-3 max-w-4xl font-serif text-4xl font-semibold sm:text-5xl">Ready To Explore Botox or Neurotoxin Treatments?</h2><p class="mx-auto mt-4 max-w-3xl leading-8 text-white/70">Book your appointment, start the Injectable Treatment Assessment, or request a phone consultation if you are not sure where to begin.</p><div class="mt-7 flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap"><a href="#contact" class="btn btn-gold justify-center">${icon("calendar")} Book Your Appointment</a><a href="#assessment" class="btn btn-ghost justify-center">${icon("sparkle")} Start Injectable Assessment</a><a href="#contact" class="btn border border-white/25 bg-white text-navy justify-center">${icon("phone")} Request A Phone Consultation</a></div></div></section>
  `;
}
...
function injectablesPage() {
  ...
  return `
    ...
    <section class="bg-navy-deep px-4 py-16 text-white"><div class="mx-auto max-w-7xl rounded-[1.5rem] border border-champagne/25 bg-white/5 p-7 text-center sm:px-10"><p class="eyebrow">Not Sure What You Need?</p><h2 class="mx-auto mt-3 max-w-4xl font-serif text-4xl font-semibold sm:text-5xl">Ready To Explore Injectable Treatments?</h2><p class="mx-auto mt-4 max-w-3xl leading-8 text-white/70">Book your appointment, start the Injectable Treatment Assessment, or request a phone consultation if you are not sure where to begin.</p><div class="mt-7 flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap"><a href="#contact" class="btn btn-gold justify-center">${icon("calendar")} Book Your Appointment</a><a href="#assessment" class="btn btn-ghost justify-center">${icon("sparkle")} Start Injectable Assessment</a><a href="#contact" class="btn border border-white/25 bg-white text-navy justify-center">${icon("phone")} Request A Phone Consultation</a></div></div></section>
  `;
}
...
function regenerativeAestheticsPage() {
  ...
  return `
    ...
    <section class="bg-navy-deep px-4 py-16 text-white"><div class="mx-auto max-w-7xl rounded-[1.5rem] border border-champagne/25 bg-white/5 p-7 text-center sm:px-10"><p class="eyebrow">Not Sure What You Need?</p><h2 class="mx-auto mt-3 max-w-4xl font-serif text-4xl font-semibold sm:text-5xl">Ready To Explore Regenerative Aesthetics?</h2><p class="mx-auto mt-4 max-w-3xl leading-8 text-white/70">Book your appointment, start the Full Treatment Assessment, or request a phone consultation if you are not sure where to begin.</p><div class="mt-7 flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap"><a href="#contact" class="btn btn-gold justify-center">${icon("calendar")} Book Your Appointment</a><a href="#assessment" class="btn btn-ghost justify-center">${icon("sparkle")} Start Treatment Assessment</a><a href="#contact" class="btn border border-white/25 bg-white text-navy justify-center">${icon("phone")} Request A Phone Consultation</a></div></div></section>
  `;
}
...
function detailedTreatmentCategoryPage(category) {
  ...
  const bookingRoute = category.bookingRoute || "#contact";
...
function focusedSkinPage(config) {
  return detailedTreatmentCategoryPage({
    primaryCta: "Book Your Appointment", secondaryCta: "Start Treatment Assessment", thirdCta: "Request A Phone Consultation", trustLine: "Performed by a Nurse Practitioner and certified injector.", icon: "sparkle",
    assessmentRoute: "#assessment", bookingRoute: "#contact", phoneRoute: "#contact",
